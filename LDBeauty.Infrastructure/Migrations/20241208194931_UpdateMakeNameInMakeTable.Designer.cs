...
namespace LDBeauty.Infrastructure.Migrations
{
    ...
    [Migration("20241208194931_UpdateMakeNameInMakeTable")]
    partial class UpdateMakeNameInMakeTable
    {
            ...
            modelBuilder.Entity("LDBeauty.Infrastructure.Data.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OrderDate = new DateTime(2024, 12, 8, 21, 49, 31, 311, DateTimeKind.Local).AddTicks(6377),
                            Phone = "1234567890",
                            TotalPrice = 79.98m
                        });
                });
